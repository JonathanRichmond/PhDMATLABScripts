...
function RotStates = P1EclipJ2000ToRot(mu, initialEpoch, P1, gm1, P2, lstar, tstar, times, states)
...
for i = 1:length(times)
    P1EclipJ2000StateDim = [states(i,1:3).*lstar, states(i,4:6).*lstar./tstar];
