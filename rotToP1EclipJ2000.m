...
cspice_furnsh({'naif0012.tls', 'de430.bsp', 'de440.bsp'}); % Load kernels
...
for i = 1:length(times)
    ...
    P2Elements = [lstar, 0, P2SPICEElements(3:5), P2SPICEElements(6)+times(i), initialEpochTime+timesDim(i), P2SPICEElements(8)]';
