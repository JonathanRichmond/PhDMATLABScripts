...
function P2EclipJ2000States = rotToP2EclipJ2000(mu, initialEpoch, P1, gm1, P2, lstar, tstar, times, states)
...
P2EclipJ2000States = zeros(length(times), 6);
for i = 1:length(times)
    ...
    P2EclipJ2000StateDim = (N*statePrimaryDim')';
    P2EclipJ2000States(i,:) = [P2EclipJ2000StateDim(1:3)./lstar, P2EclipJ2000StateDim(4:6).*tstar./lstar];
end
