...
for j = 1:length(SB1Trajs)
    ...
    plot3(SB1Trajs(j).x(1:end-150), SB1Trajs(j).y(1:end-150), SB1Trajs(j).z(1:end-150), 'Color', color, 'DisplayName', "Escape Traj. "+num2str(j))
    dot_SB1 = zeros(length(SB1Trajs(j).x(1:end-150)), 1);
